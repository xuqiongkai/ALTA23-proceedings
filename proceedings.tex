...
\begin{titlepage}
  ...
  \begin{center}
    ...
    \includegraphics[width=0.4\linewidth]{\VAR{root}/conf_logo/\VAR{conference.logo}}
    \vspace*{3cm}

    {\LARGE \VAR{conference_dates}, \VAR{conference.start_date.year}}

    {\bf\LARGE \VAR{conference.organization}}
    
    {\bf\LARGE \VAR{conference.place}}
...
\BLOCK{macro generate_sponsor_tier(tier)}
  ...
  \BLOCK{for logo_batched in tier.logos|batch(4)}
    \BLOCK{for logo in logo_batched}
      \begin{minipage}[c][0.2\linewidth][c]{0.2\linewidth}
...
\begin{itemize}[leftmargin=*,label={}]
  \BLOCK{for paper in archival_papers}
      \BLOCK{if paper.attributes.paper_type is equalto("long")}
...
\begin{itemize}[leftmargin=*,label={}]
  \BLOCK{for paper in archival_papers}
      \BLOCK{if paper.attributes.paper_type is equalto("short")}
     \item \hyperlink{page.\VAR{paper.start_page}}{\emph{\VAR{paper.title}}}\\ \hspace*{2em} \VAR{join_names(", ", paper.authors, " and ")}\dotfill \hyperlink{page.\VAR{paper.start_page}}{\VAR{paper.start_page}}
       \BLOCK{endif}
  \BLOCK{endfor}
\end{itemize}

{\textbf{Shared Task (Not Peer Reviewed)}}
\begin{itemize}[leftmargin=*,label={}]
  \BLOCK{for paper in archival_papers}
      \BLOCK{if paper.attributes.paper_type is equalto("task")}
     \item \hyperlink{page.\VAR{paper.start_page}}{\emph{\VAR{paper.title}}}\\ \hspace*{2em} \VAR{join_names(", ", paper.authors, " and ")}\dotfill \hyperlink{page.\VAR{paper.start_page}}{\VAR{paper.start_page}}
       \BLOCK{endif}
  \BLOCK{endfor}
\end{itemize}

{\textbf{Tutorial (Not Peer Reviewed)}}
\begin{itemize}[leftmargin=*,label={}]
  \BLOCK{for paper in archival_papers}
      \BLOCK{if paper.attributes.paper_type is equalto("tutorial")}
     \item \hyperlink{page.\VAR{paper.start_page}}{\emph{\VAR{paper.title}}}\\ \hspace*{2em} \VAR{join_names(", ", paper.authors, " and ")}\dotfill \hyperlink{page.\VAR{paper.start_page}}{\VAR{paper.start_page}}
       \BLOCK{endif}
  \BLOCK{endfor}
\end{itemize}
